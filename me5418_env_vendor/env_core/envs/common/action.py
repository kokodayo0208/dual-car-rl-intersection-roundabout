...
from env_core.vehicle.dynamics import BicycleVehicle
...
class ActionType:
    ...
    def vehicle_class(self) -> Callable:
        ...
        Must return a subclass of :py:class:`env_core.vehicle.kinematics.Vehicle`.
        """
        raise NotImplementedError
    ...
    def act(self, action: Action) -> None:
        ...
        vehicle is an instance of the specified :py:class:`env_core.envs.common.action.ActionType.vehicle_class`.
