...
from env_core.envs.common.action import (
    ActionType,
    ContinuousAction,
    DiscreteMetaAction,
)
from env_core.road.graphics import RoadGraphics, WorldSurface
from env_core.vehicle.graphics import VehicleGraphics


if TYPE_CHECKING:
    from env_core.envs.common.abstract import AbstractEnv, Action
...
class EnvViewer:
    ...
    def display(self) -> None:
        ...
        if self.SAVE_IMAGES and self.directory:
            pygame.image.save(
                self.sim_surface,
                str(self.directory / f"me5418-env_{self.frame}.png"),
            )
            self.frame += 1
