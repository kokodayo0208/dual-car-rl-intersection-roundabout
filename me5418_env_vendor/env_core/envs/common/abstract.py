...
from env_core.envs.common.action import Action, ActionType, action_factory
from env_core.envs.common.finite_mdp import finite_mdp
from env_core.envs.common.graphics import EnvViewer
from env_core.envs.common.observation import ObservationType, observation_factory
from env_core.vehicle.behavior import IDMVehicle
...
class AbstractEnv(gym.Env):
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "other_vehicles_type": "env_core.vehicle.behavior.IDMVehicle",
            "screen_width": 600,  # [px]
    ...
    def configure(self, config: dict) -> None:
        ...
        if "OFFSCREEN_RENDERING" in os.environ:
            ...
            warnings.warn(
                f"\033[31menv_core.{self.__class__.__name__}:\033[0m "
    ...
    def change_vehicles(self, vehicle_class_path: str) -> AbstractEnv:
        ...
        :param vehicle_class_path: The path of the class of behavior for other vehicles
                             Example: "env_core.vehicle.behavior.IDMVehicle"
